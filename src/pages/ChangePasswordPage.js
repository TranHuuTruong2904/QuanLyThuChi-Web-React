...
const ChangPasswordPage = () => {
    ...
    async function checkVerifyCode()  {
      ...
      const result = await axiosApiInstance.get(
        axiosApiInstance.defaults.baseURL + `/api/auth/verify-code/${code}`
      );
    ...
    const resetPass = async (pass) => {
      ...
      const result = await axiosApiInstance.post(
        axiosApiInstance.defaults.baseURL + `/api/auth/reset-password`,
        payload
      );
              ...
              <div className="form-panel one">
                ...
                <div className="form-content">
                  <form onSubmit={handleSubmit}>
                    ...
                    {error ? (
                      <div variant="danger">Xác thực ko đúng</div>
                    ) : null}
                    <div className="form-group">
...
export default userLayout(ChangPasswordPage);